...
const GOOGLE_API_KEY = "AIzaSyD8_cW5ybrhWkb1aWU22e75hL40_z3fnQM";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="cosmo/assets/profile.png" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="cosmo/assets/cosmos_light.svg" alt="Cosmos avatar">
